...
if ($quyen == 4) {
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])) {
        $kynang = new kynang();
        $result = $kynang->insert($_POST['name']);
    }
} else {
...
<body>
    ...
    <div class="container">
        ...
        <div class="form-add">
            <form action="themkynang.php" method="post">
                <label for="name">Tên kỹ năng</label>
                <input type="text" id="name" name="name" placeholder="Tên kỹ năng.." required>
